  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h4 class="text-light" style="color: white;">Fathur Rahman Abdullah</h4>
        <div class="social-links mt-3 text-center">
          <a href="https://web.facebook.com/atpc.fathur/" target="_blank" class="facebook"><i class="bx bxl-facebook"></i></a>
          <a href="https://www.instagram.com/fathurraaa/" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
          <a href="https://www.linkedin.com/in/fathur-rahman-6417471a0/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
        </div>
      </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Saya seorang mahasiswa jurusan teknik informatika di salah satu perguruan tinggi swasta, aktivitas keseharian saya yaitu kuliah dan saya adalah seorang web programmer freelance.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>30 May 1999</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+62 852 4248 8428</span></li>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Kab. Gowa, Sulawesi Selatan, Indonesia</span></li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span>cfteknologi@gmail.com</span></li>
      ...
      <div class="container">
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="progress">
              <span class="skill">Framework CodeIgniter <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
            ...
            <div class="progress">
              <span class="skill">Framework Laravel <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="progress">
              <span class="skill">VB.Net <i class="val">75%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Adobe XD <i class="val">40%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Figma <i class="val">40%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item">
              ...
              <h5>2005 - 2011</h5>
              <p><em>SD Inpres Pabangiang, Gowa Regency, South Sulawesi, Indonesia</em></p>
            </div>
            <div class="resume-item">
              <h4>Junior high school</h4>
              <h5>2011 - 2014</h5>
              <p><em>SMP Negeri 1 Sungguminasa, Gowa Regency, South Sulawesi, Indonesia</em></p>
            </div>
            <div class="resume-item">
              <h4>Senior High School</h4>
              <h5>2014 - 2017</h5>
              <p><em>SMAN 10 Gowa, Gowa Regency, South Sulawesi, Indonesia</em></p>
            </div>
            <div class="resume-item">
              <h4>College Student</h4>
              <h5>2018 - Now</h5>
              <p><em>STMIK Handayani Makassar, Makassar city, South Sulawesi, Indonesia</em></p>
            </div>
          </div>
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <h5>2017 - Now</h5>
              <p><em>Makassar city, South Sulawesi, Indonesia</em></p>
              <ul>
                <li>Leading a team working on a Website-Based Tourism Information System project</li>
                <li>Managed up to 5 projects or tasks at a given time while under pressure</li>
                <li>Recommended and consulted with clients about the most appropriate, attractive, and easy to use website.</li>
              </ul>
            </div>
          </div>
        </div>
